    ...
    return (
        <div className = "works">
            <div className = "works-bloc">
                ...
                <p className = "technos">Pour répondre aux problématiques de ce projet, j'ai utilisé différents outils comme AudiLighthouse et GTMetrix afin d'identifier les blocs de code à retravailler. Par ailleurs, j'ai effectué quelques ajouts comme les Google Rich Snippets. Ces différentes actions sont potentiellement intéressantes pour le référencement d'un site web. Enfin, j'ai travaillé avec l'outil Waves afin d'améliorer l'accessibilité du site. Notamment le contraste, les textes alternatifs ou l'arborescence du contenu.</p>
